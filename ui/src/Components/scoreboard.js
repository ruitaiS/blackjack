...
class ScoreBoard extends Component{
    ...
    playerEntry(player){
        ...
        return(
        <div style={{backgroundColor:player.active?"red":"grey", display:'flex', flexDirection: 'column', justifyContent:"left", border:"2px solid grey", borderRadius:"15px"}}>
    ...
    render(){
        return(
            <div style={{justifyContent: "left", position:"absolute"}}>
                {this.props.players.map(this.playerEntry)}
            </div>
        )
